...
import Draymond from '../players/draymond';
import DeandreHunter from '../players/deandre_hunter';
      ...
      <div className='flex flex-col'>
        ...
        <div className='w-20 h-20 relative mx-auto md:h-0 md:w-0 mb-6 md:mb-0'>
            <div className="absolute inset-0 
                        bg-gradient-to-r from-blue-800 to-yellow-200 animate-spin rounded-full 
                        z-10 min-h-full">
            </div>
          ...
          <p className="md:hover:scale-105 md:mr-3 m-0 w-0 h-0 md:h-auto md:p-0 md:w-auto flex justify-center items-center rounded-full md:rounded-lg text-sm border-neutral-200 text-neutral-100 no-underline bg-gradient-to-r from-blue-800 to-yellow-200">
            <NBAIcons.GSW/>
          </p>
          <div className="w-full mr-3 items-center p-1 text-sm leading-4 bg-gray-300 text-black no-underline overflow-hidden border border-neutral-200 rounded-lg opacity-80 transition duration-300 ease-in-out group-hover:opacity-100">
            ...
            <Accordion title="Draymond Green for... ">
              <div className='flex flex-col md:flex-row'>
                <div className='flex flex-col'>
                  <p className='mb-3 mt-3 px-4 md:pr-2 md:pb-2 text-[0.8rem] font-semibold'><strong className='bg-clip-text text-transparent bg-gradient-to-r from-blue-800 via-neutral-400 to-blue-950'>{`De'Andre Hunter. `}</strong>  {`I like the idea of Draymond on this Knicks team and Randle trying to be Draymond+ in Golden State, but couldn't make the math work. Ditto for getting Draymond to OKC for Shai and Chet, or a swap with Cleveland that might get Steph Garland and Allen.`}</p>
                  <p className='mb-3 px-4 md:pr-2 md:pb-2 text-[0.8rem] font-semibold'>{`I ended up with Draymond to Atlanta to work with Trae.  He works straight up for either Dejounte or Hunter, and is the perfect person to see what you can get from Trae. I consider Draymond at $22m for 3 years very team friendly so I picture GSW getting a pick here also.`}</p>
                </div>
              ...
              <div className='flex flex-wrap mt-4'>
                <div className='flex flex-col mb-3 mx-auto md:ml-3 md:mr-3'>
                  <em className='md:max-w-[300px] font-semibold text-center md:text-left'>Golden State receives:</em> 
