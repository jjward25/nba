...
const CollinSexton: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Collin Sexton');
    ...
    return (
        <div className='flex flex-col md:mr-4 rounded-lg mt-2 p-2 mx-0 border-2 border-purple-800 max-w-[250px]'>
            <input
                type="text"
