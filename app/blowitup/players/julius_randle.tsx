...
const JuliusRandle: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Julius Randle');
    ...
    return (
        <div className='flex flex-col rounded-lg mt-2 p-2 md:mr-4 mx-0 border-2 border-orange-800 max-w-[250px]'>
            <input
                type="text"
