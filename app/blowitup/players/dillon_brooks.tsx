...
const DillonBrooks: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Dillon Brooks');
    ...
    return (
        <div className='flex flex-col rounded-lg mt-2 md:mr-4 p-2 mx-0 border-2 border-red-800 max-w-[250px]'>
            <input
                type="text"
