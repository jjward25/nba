...
const Player: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Franz Wagner');
    ...
    return (
        <div className='flex flex-col rounded-lg md:mr-4 mt-2 p-2 mx-0 border-2 border-blue-800 max-w-[250px]'>
            <input
                type="text"
