...
const BenSimmons: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Ben Simmons');
    ...
    return (
        <div className='flex flex-col rounded-lg mt-2 md:mr-4 p-2 mx-0 border-2 border-gray-800 max-w-[250px]'>
            <input
                type="text"
