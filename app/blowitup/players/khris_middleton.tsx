...
const Khris: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Khris Middleton');
    ...
    return (
        <div className='flex flex-col rounded-lg md:mr-4 mt-2 p-2 mx-0 border-2 border-green-950 max-w-[250px]'>
            <input
                type="text"
