...
const TyreseMaxey: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Tyrese Maxey');
    ...
    return (
        <div className='flex text- flex-col md:mr-4 rounded-lg mt-2 p-2 mx-0 border-2 border-blue-700 max-w-[250px]'>
            <input
                type="text"
