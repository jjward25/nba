...
const Player: React.FC = () => {
    const [playerName, setPlayerName] = useState<string>('Markelle Fultz');
    ...
    return (
        <div className='flex flex-col md:mr-4 rounded-lg mt-2 p-2 mx-0 border-2 border-blue-800 max-w-[250px]'>
            <input
                type="text"
